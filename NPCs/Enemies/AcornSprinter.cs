...
namespace RealmOne.NPCs.Enemies
{
    ...
    public class AcornSprinter : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo) => spawnInfo.Player.ZoneForest && spawnInfo.Player.ZoneOverworldHeight && Main.dayTime && !spawnInfo.PlayerSafe ? 0.0895f : 0f;
