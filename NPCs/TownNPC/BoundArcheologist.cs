...
namespace RealmOne.NPCs.TownNPC
{
	public class BoundArcheologist : ModNPC
	{
		...
		{
			return "Dear God, I thought I was gonna get permanent frostbite if you didn't come to my rescue! Thank you kind lad, now excuse me but do you a kettle and tea? That would surely warm the old and frigid hands of mine right up! ";
		}
