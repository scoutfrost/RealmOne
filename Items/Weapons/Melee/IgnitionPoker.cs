...
namespace RealmOne.Items.Weapons.Melee
{
    public class IgnitionPoker : ModItem
    {
        ...
        {
            Texture2D texture = Request<Texture2D>("RealmOne/Items/Weapons/Melee/IgnitionPoker_Glowmask", AssetRequestMode.ImmediateLoad).Value;
            spriteBatch.Draw
            (
                texture,
                new Vector2
        ...
        {
            int dust = Dust.NewDust(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, DustID.FlameBurst, 0f, 0f, 0, default, 1f);
