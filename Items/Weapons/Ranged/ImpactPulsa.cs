...
namespace RealmOne.Items.Weapons.Ranged
{
    public class ImpactPulsa : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<PulsaShot>();
            Item.shootSpeed = 60f;
            Item.noMelee = true;
            Item.crit = 2;
        ...
        {
            Texture2D texture = Request<Texture2D>("RealmOne/Items/Weapons/Ranged/ImpactPulsa_Glow", AssetRequestMode.ImmediateLoad).Value;
            spriteBatch.Draw
            (
                texture,
                new Vector2
